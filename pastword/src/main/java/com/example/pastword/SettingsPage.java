...
public class SettingsPage extends StackPane {
    ...
    public SettingsPage(PastwordApp app, UserAccount account, Section initialSection) {
        ...
        getChildren().addAll(createDecorationLayer(), shell);
    ...
    private VBox createSidebar() {
        ...
        backButton.setOnAction(event -> app.showManagerPage(false));
    ...
    private VBox createProfileView() {
        ...
        PasswordField passwordField = createSettingsPasswordField();
    ...
    private PasswordField createSettingsPasswordField() {
        PasswordField field = new PasswordField();
        field.getStyleClass().add("settings-input");
        field.setPromptText("Leave blank to keep current password");
        field.setPrefWidth(360);
        return field;
    }
    ...
    private Pane createDecorationLayer() {
        ...
        pane.getChildren().addAll(
                ...
                createCircuit(900, 82, true),
                createCircuit(44, 640, false),
                createCircuit(990, 610, true)
        );
        return pane;
    }
